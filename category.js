...
function create_div_to_carousel(n, name, link){
  ...
  if (n==1){
    ...
    new_div_2.className = "shadow p-2 mb-1 bg-white grid-item";
    new_div_2.style = "border-radius: 20px;"
    ...
    new_div_3.className = "shadow p-2 mb-1 bg-white grid-item";
    new_div_3.style = "border-radius: 20px;"
...
function display_game(category){
  ...
  for(i = games_in_category.length; i < 8 ; i++){
